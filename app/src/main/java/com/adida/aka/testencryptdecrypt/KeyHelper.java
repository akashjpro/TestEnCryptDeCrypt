...
public class KeyHelper {
    ...
    public static final String PUBLIC_IV_PERSON = "PUBLIC_IV_PERSON";
    ...
    private Key getAESKeyFromKS() throws NoSuchProviderException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, KeyStoreException, CertificateException, IOException, UnrecoverableKeyException, CertificateException {
        keyStore = KeyStore.getInstance(AndroidKeyStore);
        keyStore.load(null);
    ...
    public void generateRandomIV(Context ctx){
        ...
        if(publicIV == null){
            ...
            SharedPreferences.Editor edit = pref.edit();
            edit.putString(PUBLIC_IV_PERSON, generatedIVstr);
            edit.apply();
        }
    }

    private String getStringFromSharedPrefs(String key, Context ctx){
        SharedPreferences prefs = ctx.getSharedPreferences(SHARED_PREFENCE_NAME,  Context.MODE_PRIVATE);
